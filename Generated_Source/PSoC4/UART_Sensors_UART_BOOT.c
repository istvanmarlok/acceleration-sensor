...
/*******************************************************************************
* Function Name: UART_Sensors_UartCyBtldrCommStart
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: UART_Sensors_UartCyBtldrCommStop
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: UART_Sensors_UartCyBtldrCommReset
****************************************************************************//**
*
...
void UART_Sensors_UartCyBtldrCommReset(void)
{
    ...
    UART_Sensors_SpiUartClearRxBuffer();
    UART_Sensors_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: UART_Sensors_UartCyBtldrCommRead
****************************************************************************//**
*
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != UART_Sensors_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = UART_Sensors_SpiUartGetRxBufferSize();
                    CyDelayUs(UART_Sensors_UART_BYTE_TO_BYTE);
                }
                while (byteCount != UART_Sensors_SpiUartGetRxBufferSize());

                byteCount = UART_Sensors_BYTES_TO_COPY(byteCount, size);
            ...
            CyDelay(UART_Sensors_WAIT_1_MS);
            --timeoutMs;
        }
        while (0u != timeoutMs);
        ...
        {
            pData[i] = (uint8) UART_Sensors_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: UART_Sensors_UartCyBtldrCommWrite
****************************************************************************//**
*
...
cystatus UART_Sensors_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        UART_Sensors_SpiUartPutArray(pData, (uint32) size);
